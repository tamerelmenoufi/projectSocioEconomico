...
<?php
    ...
    $query = "SELECT * FROM dashboard where grafico = 'graficos/rural/{$_SESSION['filtro_relatorio_municipio']}/{$_SESSION['filtro_relatorio_tipo']}/{$_SESSION['filtro_relatorio_bairro_comunidade']}'";
