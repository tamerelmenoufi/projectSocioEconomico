...
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
  ...
  <div class="offcanvas-body">
    ...
    <div class="row mb-1">
      <div class="col">
        <a href="./docs/form_se.pdf" target="formSocioEconimico" class="text-decoration-none">
    ...
    <div class="row mb-1">
      <div class="col">
        <a href="./docs/form_ef.pdf" target="formEstruturaFamiliar" class="text-decoration-none">
